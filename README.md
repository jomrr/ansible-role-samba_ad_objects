...
[![dev](https://img.shields.io/github/actions/workflow/status/jomrr/ansible-role-samba_ad_objects/dev.yml?branch=dev&event=push&label=dev)](https://github.com/jomrr/ansible-role-samba_ad_objects/actions/workflows/dev.yml?query=branch%3Adev)
[![main](https://img.shields.io/github/actions/workflow/status/jomrr/ansible-role-samba_ad_objects/main.yml?branch=main&event=push&label=main)](https://github.com/jomrr/ansible-role-samba_ad_objects/actions/workflows/main.yml?query=branch%3Amain)
